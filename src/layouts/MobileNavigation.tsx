...
export const MobileNavigation: React.FC = () => {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 z-30 px-2 py-1 shadow-lg">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex flex-col items-center py-1.5 px-3 rounded-xl transition-all ${
                isActive ? 'text-indigo-600 font-black' : 'text-slate-500 font-medium'
              }`
            }
          >
