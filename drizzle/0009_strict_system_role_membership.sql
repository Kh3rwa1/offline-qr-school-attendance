-- Migration 0009: Strict Group Role Membership RLS & Force RLS Hardening
-- Authorizes system context ONLY when pg_has_role(current_user, 'attendance_system_rls', 'member') AND app.is_system='true'.
